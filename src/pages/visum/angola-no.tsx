              ...
              <div className="bg-[#CE1126]/5 p-6 rounded-lg border border-[#CE1126]/20">
                <h3 className="font-semibold text-lg mb-4">
                  {documentRequirements.length > 0 && selectedProductName
                    ? `Dokumenter som kreves for ${selectedProductName}:`
                      ...
                      <li key={doc.id} className="flex items-start">
                        ...
                        <div>
                          ...
                          {doc.templateUrl && (
                            ...
                            >
                              📎 {locale === 'en' ? 'Download form' : 'Last ned skjema'}
                            </a>
                          )}
                        </div>
                      </li>
                ...
                <p className="text-xs text-gray-500 mt-4">* = Obligatorisk</p>
                ...
                <div className="mt-6 pt-4 border-t border-[#CE1126]/20">
                  ...
                  >
                    📄 {locale === 'en' ? 'Download Visa Application Form (PDF)' : 'Last ned visumsøknad (PDF)'}
                  </a>
                </div>
              </div>
            </div>
