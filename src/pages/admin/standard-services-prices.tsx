                    ...
                    {service.code === 'translation' ? (
                      ...
                      <>
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div className="bg-gray-50 rounded-lg p-4">
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              Official fee <span className="text-xs text-gray-400 font-normal">(excl. VAT)</span>
                            </label>
                            <div className="flex items-center">
                              <input
                                type="number"
                          ...
                          <div className="bg-gray-50 rounded-lg p-4">
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              Service fee <span className="text-xs text-gray-400 font-normal">(excl. VAT)</span>
                            </label>
                            <div className="flex items-center">
                              <input
                                type="number"
                        ...
                        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <span className="text-lg font-semibold text-green-900">Starting price <span className="text-sm font-normal text-green-700">(excl. VAT)</span>:</span>
                      ...
                      <>
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div className="bg-gray-50 rounded-lg p-4">
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              Official fee <span className="text-xs text-gray-400 font-normal">({['ud', 'embassy'].includes(service.code) ? '0% VAT' : 'excl. VAT'})</span>
                            </label>
                            <div className="flex items-center">
                              <input
                                type="number"
                        ...
                        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <span className="text-lg font-semibold text-green-900">Total price <span className="text-sm font-normal text-green-700">(excl. VAT)</span>:</span>
