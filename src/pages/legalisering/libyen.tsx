...
export default function LibyenLegaliseringPage() {
  const country = { name: 'Libyen', flag: '🇱🇾', color: '#239E46', colorDark: '#1a7534' };
  const embassy = {
    name: 'Libyens ambassad i Stockholm',
    address: 'Herserudsvägen 18',
    postalCode: '181 34 Lidingö',
    phone: '+46 8 767 29 90',
    email: 'info@libyanembassy.se',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Vi hjälper dig med legalisering av dokument för ${country.name}. Komplett service via Libyens ambassad i Stockholm.`} />
        <link rel="canonical" href="https://www.doxvl.se/legalisering/libyen" />
      </Head>
