...
export default function EtiopienLegaliseringPage() {
  const country = { name: 'Etiopien', flag: '🇪🇹', color: '#078930', colorDark: '#056622' };
  const embassy = {
    name: 'Etiopiens ambassad i Stockholm',
    address: 'Birger Jarlsgatan 39, Box 10448',
    postalCode: '100 55 Stockholm',
    phone: '+46 8 120 485 00',
    email: 'stockholm.embassy@mfa.gov.et',
    openingHours: 'Måndag-Fredag 09:00-17:00'
  };

  const documents = ['Personbevis och födelsebevis', 'Vigselbevis', 'Examensbevis och utbildningsintyg', 'Fullmakter', 'Bolagshandlingar', 'Adoptionsdokument'];

  return (
    <>
      <Head>
        <title>Legalisering för {country.name} - Ambassad Stockholm | DOX Visumpartner</title>
        <meta name="description" content={`Vi hjälper dig med legalisering av dokument för ${country.name}. Komplett service via Etiopiens ambassad i Stockholm.`} />
        <link rel="canonical" href="https://www.doxvl.se/legalisering/etiopien" />
      </Head>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700"><strong>Öppettider:</strong> {embassy.openingHours}</p>
            </div>
