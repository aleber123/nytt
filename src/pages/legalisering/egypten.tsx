...
export default function EgyptenLegaliseringPage() {
  const country = { name: 'Egypten', flag: '🇪🇬', color: '#C8102E', colorDark: '#9a0c23' };
  const embassy = {
    name: 'Egyptens ambassad i Stockholm',
    address: 'Strandvägen 35',
    postalCode: '114 56 Stockholm',
    phone: '+46 8 679 57 50',
    email: 'embassy.stockholm@mfa.gov.eg',
    website: 'https://embassyofegypt.se',
    openingHours: 'Måndag-Fredag 09:00-15:00'
  };

  const documents = ['Personbevis och födelsebevis', 'Vigselbevis och äktenskapsintyg', 'Examensbevis', 'Fullmakter', 'Bolagshandlingar', 'Handelsdokument och ursprungsintyg'];

  return (
    <>
      <Head>
        <title>Legalisering för {country.name} - Ambassad Stockholm | DOX Visumpartner</title>
        <meta name="description" content={`Vi hjälper dig med legalisering av dokument för ${country.name}. Komplett service via Egyptens ambassad i Stockholm. Snabb hantering.`} />
        <link rel="canonical" href="https://www.doxvl.se/legalisering/egypten" />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8">
            <div><h2 className="text-2xl font-bold mb-4">Dokument för {country.name}</h2><p className="text-gray-700">{country.name} kräver att utländska dokument legaliseras. Vi hanterar hela processen åt dig.</p></div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700"><strong>Webbplats:</strong> <a href={embassy.website} className="text-blue-600 hover:underline">{embassy.website}</a></p>
            </div>
