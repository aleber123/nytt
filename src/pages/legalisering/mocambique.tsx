...
export default function MocambiqueLegaliseringPage() {
  ...
  return (
    <>
      <LegaliseringCountrySEO
        ...
        countryCode="MZ"
        slug="mocambique"
        title="Legalisering för Moçambique | DOX Visumpartner"
        titleEn="Document Legalization for Mozambique | DOX Visumpartner"
        description="Vi hjälper dig med legalisering av dokument för Moçambique. Komplett service inkl. notarisering, UD och ambassadlegalisering. Fast pris, snabb hantering."
        descriptionEn="We help you with document legalization for Mozambique. Complete service including notarization, MFA and embassy legalization."
        keywords="Moçambique legalisering, legalisering Moçambique, Moçambiques ambassad Stockholm, legalisera dokument Moçambique, ambassadlegalisering Moçambique, Maputo, dokumentlegalisering"
        priceLow="1200"
        priceHigh="4500"
        faqItems={[
          { question: 'Hur legaliserar jag dokument för Moçambique?', answer: 'Legaliseringsprocessen inkluderar notarisering, UD-verifiering och slutlig legalisering. DOX Visumpartner hanterar hela processen åt dig.' },
          { question: 'Hur lång tid tar legalisering för Moçambique?', answer: 'Normalt 5-15 arbetsdagar beroende på dokumenttyp och handläggningstider.' },
          { question: 'Vad kostar legalisering för Moçambique?', answer: 'Kontakta oss för en kostnadsfri offert. Vi erbjuder fasta priser utan dolda avgifter.' },
        ]}
      />
