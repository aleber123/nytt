...
export default function MocambiqueLegaliseringPage() {
  const country = { name: 'Moçambique', flag: '🇲🇿', color: '#007168', colorDark: '#00524c' };
  const embassy = {
    name: 'Moçambiques ambassad i Stockholm',
    address: 'Tingsvägen 19, 9:e våningen',
    postalCode: '191 61 Sollentuna',
    phone: '+46 8 666 03 50',
    email: 'information@embmozambique.se',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Vi hjälper dig med legalisering av dokument för ${country.name}. Komplett service via Moçambiques ambassad i Sollentuna.`} />
        <link rel="canonical" href="https://www.doxvl.se/legalisering/mocambique" />
      </Head>
      <Header />
