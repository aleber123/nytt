              ...
              onClick={async (event) => {
                ...
                try {
                  ...
                  const orderData = {
                    ...
                    willSendMainDocsLater: answers.willSendMainDocsLater || false,
                    scannedCopies: answers.scannedCopies,
                    pickupService: answers.pickupService,
                    ...
                    confirmReturnAddressLater: answers.confirmReturnAddressLater || false,
                    returnAddressConfirmationRequired: answers.confirmReturnAddressLater || false,
