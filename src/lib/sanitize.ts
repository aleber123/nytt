...
const ALLOWED_ORDER_FIELDS = [
  ...
  'pickupService',
  'pickupAddress',
  'willSendMainDocsLater',
  'ownDeliveryReturnEmailSent',
  'ownDeliveryReturnEmailSentAt',
  'officePickupReadyEmailSent',
  'officePickupReadyEmailSentAt',
  'dhlShipmentBooked',
  'dhlShipmentBookedAt',
  'dhlLabelBase64',
  'postnordShipmentBooked',
